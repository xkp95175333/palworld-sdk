...
public:
	...
	uint8                                         Pad_550E[0x7];                                     // 0x0361(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_550F[0x4];                                     // 0x038C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void OnPassingCapturePhase______0(int32 PhaseCount, class UPalIndividualCharacterHandle* Param_TargetHandle);
	...
	void PlaySoundShake();
	void PrevIndexFullPercentage(int32 Param_Index, bool* IsFull);
