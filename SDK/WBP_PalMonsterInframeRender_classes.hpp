...
public:
	...
	uint8                                         Pad_557F[0x7];                                     // 0x0429(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UWBP_PalMonsterInframeRender_C) == 0x000458, "Wrong size on UWBP_PalMonsterInframeRender_C");
