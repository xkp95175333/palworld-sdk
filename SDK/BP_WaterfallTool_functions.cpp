...
// double                                  Scale                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// TArray<class AActor*>                   Param_Actors_to_Ignore                                 (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)

void ABP_WaterfallTool_C::Do_Waterfall_Trace(class USplineComponent* Spline_Input, double Scale, TArray<class AActor*>& Param_Actors_to_Ignore)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Scale = Scale;
	Parms.Param_Actors_to_Ignore = std::move(Param_Actors_to_Ignore);

	UObject::ProcessEvent(Func, &Parms);

	Param_Actors_to_Ignore = std::move(Parms.Param_Actors_to_Ignore);
}
