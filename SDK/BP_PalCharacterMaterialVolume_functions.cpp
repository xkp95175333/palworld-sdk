...
// double                                  Param_Light_Affect_Emissive_Intensity                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// double                                  Param_Light_Affect_Emissive_Min                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// double                                  Param_Light_Affect_Emissive_Max                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// double                                  Param_Base_Emissive_Intensity                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// double                                  Param_Base_Color_Intensity                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_PalCharacterMaterialVolume_C::SetParameters(class UMaterialInstanceDynamic* Material, double Param_Light_Affect_Emissive_Intensity, double Param_Light_Affect_Emissive_Min, double Param_Light_Affect_Emissive_Max, double Param_Base_Emissive_Intensity, double Param_Base_Color_Intensity)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_Light_Affect_Emissive_Intensity = Param_Light_Affect_Emissive_Intensity;
	Parms.Param_Light_Affect_Emissive_Min = Param_Light_Affect_Emissive_Min;
	Parms.Param_Light_Affect_Emissive_Max = Param_Light_Affect_Emissive_Max;
	Parms.Param_Base_Emissive_Intensity = Param_Base_Emissive_Intensity;
	Parms.Param_Base_Color_Intensity = Param_Base_Color_Intensity;
