...
static_assert(sizeof(ABP_PalMapObjectSpawnerTreasureBox_VisibleContent_grassDrop2_C) == 0x000308, "Wrong size on ABP_PalMapObjectSpawnerTreasureBox_VisibleContent_grassDrop2_C");
static_assert(offsetof(ABP_PalMapObjectSpawnerTreasureBox_VisibleContent_grassDrop2_C, DebugMarker) == 0x0002E8, "Member 'ABP_PalMapObjectSpawnerTreasureBox_VisibleContent_grassDrop2_C::DebugMarker' has a wrong offset!");
static_assert(offsetof(ABP_PalMapObjectSpawnerTreasureBox_VisibleContent_grassDrop2_C, Scene) == 0x0002F0, "Member 'ABP_PalMapObjectSpawnerTreasureBox_VisibleContent_grassDrop2_C::Scene' has a wrong offset!");
static_assert(offsetof(ABP_PalMapObjectSpawnerTreasureBox_VisibleContent_grassDrop2_C, Arrow) == 0x0002F8, "Member 'ABP_PalMapObjectSpawnerTreasureBox_VisibleContent_grassDrop2_C::Arrow' has a wrong offset!");
static_assert(offsetof(ABP_PalMapObjectSpawnerTreasureBox_VisibleContent_grassDrop2_C, VisualActor) == 0x000300, "Member 'ABP_PalMapObjectSpawnerTreasureBox_VisibleContent_grassDrop2_C::VisualActor' has a wrong offset!");
