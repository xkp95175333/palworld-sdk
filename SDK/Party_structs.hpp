...
public:
	...
	uint8                                         Pad_16B0[0x7];                                     // 0x0041(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_16B1[0x18];                                    // 0x0000(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_16B2[0x8];                                     // 0x0018(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPartyMemberPlatformData               PlatformData;                                      // 0x0020(0x0098)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_16B3[0x90];                                    // 0x00B8(0x0090)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16B4[0x37];                                    // 0x0149(0x0037)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 JoinMethod;                                        // 0x0180(0x0010)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_16B5[0x30];                                    // 0x0190(0x0030)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPartyMemberJoinInProgressData         JoinInProgressData;                                // 0x01C0(0x0048)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_16B6[0x60];                                    // 0x0208(0x0060)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_16B7[0x8];                                     // 0x0018(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPartyPrivacySettings                  PrivacySettings;                                   // 0x0020(0x0003)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_16B8[0x35];                                    // 0x0023(0x0035)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_16B9[0x18];                                    // 0x0068(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_16BA[0x10];                                    // 0x0008(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class USocialChatChannel*>             ListenChannels;                                    // 0x0018(0x0010)(ZeroConstructor, UObjectWrapper, NativeAccessSpecifierPublic)
	uint8                                         Pad_16BB[0x18];                                    // 0x0028(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
