...
public:
	...
	class UVerticalBox*                           VerticalBox_DeathLog;                              // 0x0430(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	uint8                                         Pad_54E8[0x4];                                     // 0x046C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	TArray<class UWBP_Notice_Deathlog_C*>         QueuedDeathLogList;                                // 0x0530(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
...
public:
	...
	void CREATEDELEGATE_PROXYFUNCTION_0(const class FText& LogText, const TSoftObjectPtr<class UTexture2D> Icon);
	...
	void OnAddedDeathLog(const class FText& LogText, TSoftObjectPtr<class UTexture2D> Icon);
...
static_assert(offsetof(UWBP_PalLogWidget_C, VerticalBox_DeathLog) == 0x000430, "Member 'UWBP_PalLogWidget_C::VerticalBox_DeathLog' has a wrong offset!");
...
static_assert(offsetof(UWBP_PalLogWidget_C, QueuedDeathLogList) == 0x000530, "Member 'UWBP_PalLogWidget_C::QueuedDeathLogList' has a wrong offset!");
