...
public:
	...
	uint8                                         Pad_4A2B[0x6];                                     // 0x04EA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4A2C[0x5];                                     // 0x05AB(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void Setup(const struct FVector& Param_MinLandScapePosition, const struct FVector& Param_MaxLandScapePosition);
