...
public:
	...
	void GetPrePreset(int32 Param_Index, class UPPSkyCreatorWeatherPreset** Pre);
	void GetPresets(double Param_Time, class UPPSkyCreatorWeatherPreset** CurrentPreset, class UPPSkyCreatorWeatherPreset** NextPreset, double* Param_Alpha, int32* PresetIndex);
