...
void UWBP_PalGetReticle_C::DisplayCaptureNum(int32 CaptureCount)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PalGetReticle_C", "DisplayCaptureNum");

	Params::WBP_PalGetReticle_C_DisplayCaptureNum Parms{};
...
void UWBP_PalGetReticle_C::SetCaptureRateFromListIndex(int32 Param_Index)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// TArray<double>                          Param_RateList                                         (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)

void UWBP_PalGetReticle_C::SetCaptureRateList(TArray<double>& Param_RateList)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_RateList = std::move(Param_RateList);

	UObject::ProcessEvent(Func, &Parms);

	Param_RateList = std::move(Parms.Param_RateList);
}
