...
public:
	...
	class UPalIndividualCharacterParameter*       Individual_Parameter;                              // 0x02D8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	TMap<int32, class UPalActiveSkill*>           CurrentSkillMap;                                   // 0x02E0(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance)
...
static_assert(sizeof(UWBP_PalSkill_KeyGuide_C) == 0x000330, "Wrong size on UWBP_PalSkill_KeyGuide_C");
...
static_assert(offsetof(UWBP_PalSkill_KeyGuide_C, Individual_Parameter) == 0x0002D8, "Member 'UWBP_PalSkill_KeyGuide_C::Individual_Parameter' has a wrong offset!");
static_assert(offsetof(UWBP_PalSkill_KeyGuide_C, CurrentSkillMap) == 0x0002E0, "Member 'UWBP_PalSkill_KeyGuide_C::CurrentSkillMap' has a wrong offset!");
