...
public:
	...
	uint8                                         Pad_26CC[0x3];                                     // 0x0029(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_26CD[0x3];                                     // 0x0035(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_26CE[0x3];                                     // 0x0041(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_26CF[0x4];                                     // 0x004C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_26D0[0x7];                                     // 0x0029(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_26D1[0x70];                                    // 0x0290(0x0070)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_26D2[0x98];                                    // 0x0068(0x0098)(Fixing Size After Last Property [ Dumper-7 ])
