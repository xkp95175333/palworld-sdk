...
void UWBP_CapturingPalLoupe_C::GetLoupeWidgetSize(struct FVector2D* Param_WidgetSize)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class ABP_PalCaptureBodyBase_C*         Param_TargetCaptureBody                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// class UPalIndividualCharacterHandle*    TargetHandle                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UWBP_CapturingPalLoupe_C::Setup(class ABP_PalCaptureBodyBase_C* Param_TargetCaptureBody, class UPalIndividualCharacterHandle* TargetHandle)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_TargetCaptureBody = Param_TargetCaptureBody;
	Parms.TargetHandle = TargetHandle;
