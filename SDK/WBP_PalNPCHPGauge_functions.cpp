...
void UWBP_PalNPCHPGauge_C::IsDead(bool* Param_IsDead)
{
	static class UFunction* Func = nullptr;
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// bool                                    Param_IsFriend                                         (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_PalNPCHPGauge_C::IsFriend(bool* Param_IsFriend)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_IsFriend != nullptr)
		*Param_IsFriend = Parms.Param_IsFriend;
}
...
// Parameters:
// bool                                    Param_IsOtomo                                          (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_PalNPCHPGauge_C::IsOtomo(bool* Param_IsOtomo)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_IsOtomo != nullptr)
		*Param_IsOtomo = Parms.Param_IsOtomo;
}
