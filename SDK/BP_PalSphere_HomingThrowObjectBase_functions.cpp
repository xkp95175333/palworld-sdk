...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// EPalCaptureSphereLevelType              Param_CaptureLevelType                                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_PalSphere_HomingThrowObjectBase_C::SetMaterialByType(EPalCaptureSphereLevelType Param_CaptureLevelType)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_CaptureLevelType = Param_CaptureLevelType;
