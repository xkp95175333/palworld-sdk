...
public:
	...
	TMap<class UPalLocationPoint*, struct FGuid>  DeathMarkMap;                                      // 0x0538(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance)
	TArray<class UWBP_Map_IconDeath_C*>           DeathMarks;                                        // 0x0588(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	TArray<class UWBP_Map_IconTower_C*>           BossTowerIcons;                                    // 0x0598(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	bool                                          CustomMarkMode;                                    // 0x05A8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          FilterOpened;                                      // 0x05A9(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_52F4[0x6];                                     // 0x05AA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UWBP_WorldMap_IconBase_NoDesign_C*      CurrentSetupIcon;                                  // 0x05B0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                          For_Respawn;                                       // 0x05B8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_52F5[0x7];                                     // 0x05B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UWBP_Map_IconPlayer_C*>          PlayerIcons;                                       // 0x05C0(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	bool                                          Can_Fast_Travel;                                   // 0x05D0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          IsInitSelect;                                      // 0x05D1(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_52F6[0x6];                                     // 0x05D2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TSet<EPalLocationType>                        FilterIconTypes;                                   // 0x05D8(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FDataTableRowHandle                    FTMsgID;                                           // 0x0628(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	struct FDataTableRowHandle                    RespawnMsgID;                                      // 0x0638(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)
	TArray<class UWBP_Map_IconBoss_C*>            BossIcons;                                         // 0x0648(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
	class FName                                   DismantalActionName;                               // 0x0658(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FDataTableRowHandle                    InitSelectMsgID;                                   // 0x0660(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance, NoDestructor)

public:
	void AddBossIcon(class ABP_PalSpawner_Standard_C* Spawner, const struct FVector& Location);
	void ChangeCustomIcon(class UWBP_Map_IconCustom_C* Icon, int32 Param_Index);
	void ChangeFilter(EPalLocationType FilterMap, bool IsEnable);
	void CloseMap();
	void Collect_Boss_Pal_Spawner();
	void Collect_Icon_in_Initialize();
	void CollectAndAddIcon(class UClass* CollectActorClass, class UClass* AddWidgetClass);
	void EnableCustomMark();
	void ExecuteUbergraph_WBP_Map_Base(int32 EntryPoint);
	void OnCloseAction();
	void OnCustomMarkChanged(int32 Param_Index);
	...
	void SetupLocationPointIcon(const struct FGuid& LocationId, class UPalLocationBase* Location);
...
static_assert(sizeof(UWBP_Map_Base_C) == 0x000670, "Wrong size on UWBP_Map_Base_C");
...
static_assert(offsetof(UWBP_Map_Base_C, DeathMarkMap) == 0x000538, "Member 'UWBP_Map_Base_C::DeathMarkMap' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, DeathMarks) == 0x000588, "Member 'UWBP_Map_Base_C::DeathMarks' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, BossTowerIcons) == 0x000598, "Member 'UWBP_Map_Base_C::BossTowerIcons' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, CustomMarkMode) == 0x0005A8, "Member 'UWBP_Map_Base_C::CustomMarkMode' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, FilterOpened) == 0x0005A9, "Member 'UWBP_Map_Base_C::FilterOpened' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, CurrentSetupIcon) == 0x0005B0, "Member 'UWBP_Map_Base_C::CurrentSetupIcon' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, For_Respawn) == 0x0005B8, "Member 'UWBP_Map_Base_C::For_Respawn' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, PlayerIcons) == 0x0005C0, "Member 'UWBP_Map_Base_C::PlayerIcons' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, Can_Fast_Travel) == 0x0005D0, "Member 'UWBP_Map_Base_C::Can_Fast_Travel' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, IsInitSelect) == 0x0005D1, "Member 'UWBP_Map_Base_C::IsInitSelect' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, FilterIconTypes) == 0x0005D8, "Member 'UWBP_Map_Base_C::FilterIconTypes' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, FTMsgID) == 0x000628, "Member 'UWBP_Map_Base_C::FTMsgID' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, RespawnMsgID) == 0x000638, "Member 'UWBP_Map_Base_C::RespawnMsgID' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, BossIcons) == 0x000648, "Member 'UWBP_Map_Base_C::BossIcons' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, DismantalActionName) == 0x000658, "Member 'UWBP_Map_Base_C::DismantalActionName' has a wrong offset!");
static_assert(offsetof(UWBP_Map_Base_C, InitSelectMsgID) == 0x000660, "Member 'UWBP_Map_Base_C::InitSelectMsgID' has a wrong offset!");
