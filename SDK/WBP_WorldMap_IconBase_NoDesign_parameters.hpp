...
public:
	...
	uint8                                         Pad_52E3[0x7];                                     // 0x0021(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	struct FGuid                                  Param_LocationId;                                  // 0x0008(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(WBP_WorldMap_IconBase_NoDesign_C_Setup, Param_LocationId) == 0x000008, "Member 'WBP_WorldMap_IconBase_NoDesign_C_Setup::Param_LocationId' has a wrong offset!");
