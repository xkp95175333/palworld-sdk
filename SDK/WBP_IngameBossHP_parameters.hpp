...
public:
	...
	uint8                                         Pad_35BD[0x3];                                     // 0x0299(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   CallFunc_GetCharacterID_ReturnValue;               // 0x029C(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_GetIsTowerBoss_ReturnValue;               // 0x02A4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_GetIsRaidBoss_ReturnValue;                // 0x02A5(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_BooleanOR_ReturnValue;                    // 0x02A6(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_IngameBossHP_C_Set_Enable_Talent_Detail) == 0x0002A8, "Wrong size on WBP_IngameBossHP_C_Set_Enable_Talent_Detail");
...
static_assert(offsetof(WBP_IngameBossHP_C_Set_Enable_Talent_Detail, CallFunc_IsValid_ReturnValue) == 0x000298, "Member 'WBP_IngameBossHP_C_Set_Enable_Talent_Detail::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameBossHP_C_Set_Enable_Talent_Detail, CallFunc_GetCharacterID_ReturnValue) == 0x00029C, "Member 'WBP_IngameBossHP_C_Set_Enable_Talent_Detail::CallFunc_GetCharacterID_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameBossHP_C_Set_Enable_Talent_Detail, CallFunc_GetIsTowerBoss_ReturnValue) == 0x0002A4, "Member 'WBP_IngameBossHP_C_Set_Enable_Talent_Detail::CallFunc_GetIsTowerBoss_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameBossHP_C_Set_Enable_Talent_Detail, CallFunc_GetIsRaidBoss_ReturnValue) == 0x0002A5, "Member 'WBP_IngameBossHP_C_Set_Enable_Talent_Detail::CallFunc_GetIsRaidBoss_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_IngameBossHP_C_Set_Enable_Talent_Detail, CallFunc_BooleanOR_ReturnValue) == 0x0002A6, "Member 'WBP_IngameBossHP_C_Set_Enable_Talent_Detail::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_35BE[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_35BF[0x4];                                     // 0x00A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
