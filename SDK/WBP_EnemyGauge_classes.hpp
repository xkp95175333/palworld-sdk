...
public:
	...
	uint8                                         Pad_2399[0x7];                                     // 0x0459(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_239A[0x4];                                     // 0x046C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void SetTargetName(const class FText& Param_Name);
	void SetVisibilityBattleIcon(ESlateVisibility Visibiliy);
	void SetVisibilitySanityGauge(ESlateVisibility Param_Visibility);
	void SetVisibilityStrongRareMark(ESlateVisibility Param_Visibility);
