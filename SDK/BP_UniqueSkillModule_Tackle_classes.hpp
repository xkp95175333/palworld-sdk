...
public:
	...
	uint8                                         Pad_498E[0x7];                                     // 0x0091(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_498F[0x7];                                     // 0x00D1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void GetCurrentState(EAction_Unique_Tackle* Param_State);
	void OnBeginModule();
	...
	void OnStartTossin();
	void SetFlagName(class FName Param_FlagName);
