...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_SquadNPCSpawner_ForCampBase_C;   // 0x0458(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(ABP_SquadNPCSpawner_ForCampBase_C) == 0x000460, "Wrong size on ABP_SquadNPCSpawner_ForCampBase_C");
static_assert(offsetof(ABP_SquadNPCSpawner_ForCampBase_C, UberGraphFrame_BP_SquadNPCSpawner_ForCampBase_C) == 0x000458, "Member 'ABP_SquadNPCSpawner_ForCampBase_C::UberGraphFrame_BP_SquadNPCSpawner_ForCampBase_C' has a wrong offset!");
