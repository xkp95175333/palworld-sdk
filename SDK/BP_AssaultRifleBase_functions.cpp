...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// struct FVector                          Param_TargetPosition                                   (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_AssaultRifleBase_C::GetTargetPosition(struct FVector* Param_TargetPosition)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_TargetPosition != nullptr)
		*Param_TargetPosition = std::move(Parms.Param_TargetPosition);
}
