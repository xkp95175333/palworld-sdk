...
// struct FGuid                            Param_LocationId                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_WorldMap_IconBase_NoDesign_C::Setup(class UPalLocationPoint* LocationPoint, const struct FGuid& Param_LocationId)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_LocationId = std::move(Param_LocationId);
