...
public:
	...
	uint8                                         Pad_5404[0xC];                                     // 0x0004(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_5406[0x7];                                     // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5407[0x4];                                     // 0x0084(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPalIndividualCharacterSaveParameter   CallFunc_GetCharacterSaveParameter_ReturnValue;    // 0x0088(0x0280)(ConstParm)
	TSoftObjectPtr<class UTexture2D>              CallFunc_GetCharacterIconTexture_ReturnValue;      // 0x0308(0x0030)(UObjectWrapper, HasGetValueTypeHash)
	TSoftObjectPtr<class UTexture2D>              CallFunc_GetCharacterIconTexture_ReturnValue_1;    // 0x0338(0x0030)(UObjectWrapper, HasGetValueTypeHash)
};
...
static_assert(sizeof(WBP_CompassIcon_ForPal_C_SetupTexture) == 0x000368, "Wrong size on WBP_CompassIcon_ForPal_C_SetupTexture");
...
static_assert(offsetof(WBP_CompassIcon_ForPal_C_SetupTexture, CallFunc_GetCharacterIconTexture_ReturnValue) == 0x000308, "Member 'WBP_CompassIcon_ForPal_C_SetupTexture::CallFunc_GetCharacterIconTexture_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_CompassIcon_ForPal_C_SetupTexture, CallFunc_GetCharacterIconTexture_ReturnValue_1) == 0x000338, "Member 'WBP_CompassIcon_ForPal_C_SetupTexture::CallFunc_GetCharacterIconTexture_ReturnValue_1' has a wrong offset!");
