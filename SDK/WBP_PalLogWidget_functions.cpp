...
// TSoftObjectPtr<class UTexture2D>        Icon                                                   (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, UObjectWrapper, HasGetValueTypeHash)

void UWBP_PalLogWidget_C::CREATEDELEGATE_PROXYFUNCTION_0(const class FText& LogText, const TSoftObjectPtr<class UTexture2D> Icon)
{
	static class UFunction* Func = nullptr;
...
void UWBP_PalLogWidget_C::OnAddedDeathLog(const class FText& LogText, TSoftObjectPtr<class UTexture2D> Icon)
{
	static class UFunction* Func = nullptr;
...
void UWBP_PalLogWidget_C::UpdateDeathLog()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WBP_PalLogWidget_C", "UpdateDeathLog");
