...
void UWBP_PalNPCHPGaugeCanvas_C::AddBossGauge(class APalCharacter* TargetCharacter)
{
	static class UFunction* Func = nullptr;
	...
	Params::WBP_PalNPCHPGaugeCanvas_C_AddBossGauge Parms{};
...
// Parameters:
// bool                                    Param_IsAiming                                         (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_PalNPCHPGaugeCanvas_C::IsAiming(bool* Param_IsAiming)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_IsAiming != nullptr)
		*Param_IsAiming = Parms.Param_IsAiming;
}
...
// (Private, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// bool                                    Param_IsConflict                                       (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_PalNPCHPGaugeCanvas_C::IsConflict(bool* Param_IsConflict)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_IsConflict != nullptr)
		*Param_IsConflict = Parms.Param_IsConflict;
}
