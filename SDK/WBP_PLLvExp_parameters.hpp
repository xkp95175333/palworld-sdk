...
public:
	...
	uint8                                         Pad_54B5[0x2];                                     // 0x0006(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_54B6[0x6];                                     // 0x003A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class UPalGameSetting*                        CallFunc_GetGameSetting_ReturnValue;               // 0x0040(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	TDelegate<void(int32 AddExp, int32 OldExp, double NowExpRate)> K2Node_CreateDelegate_OutputDelegate_1;            // 0x0048(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_54B7[0x4];                                     // 0x00AC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_54B8[0x7];                                     // 0x00B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_54B9[0x7];                                     // 0x00E9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_54BA[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_54BB[0x7];                                     // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(WBP_PLLvExp_C_SetAddExpText) == 0x000090, "Wrong size on WBP_PLLvExp_C_SetAddExpText");
...
static_assert(offsetof(WBP_PLLvExp_C_SetAddExpText, CallFunc_Conv_IntToInt64_ReturnValue) == 0x000008, "Member 'WBP_PLLvExp_C_SetAddExpText::CallFunc_Conv_IntToInt64_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WBP_PLLvExp_C_SetAddExpText, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x000060, "Member 'WBP_PLLvExp_C_SetAddExpText::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PLLvExp_C_SetAddExpText, K2Node_MakeArray_Array) == 0x000068, "Member 'WBP_PLLvExp_C_SetAddExpText::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(WBP_PLLvExp_C_SetAddExpText, CallFunc_Format_ReturnValue) == 0x000078, "Member 'WBP_PLLvExp_C_SetAddExpText::CallFunc_Format_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_54BC[0x3];                                     // 0x0015(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        CallFunc_UpdateGaugeEdgeImagePosition_percent_ImplicitCast; // 0x0018(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_54BD[0x4];                                     // 0x0024(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(WBP_PLLvExp_C_UpdateExp) == 0x000030, "Wrong size on WBP_PLLvExp_C_UpdateExp");
static_assert(offsetof(WBP_PLLvExp_C_UpdateExp, AddExp) == 0x000000, "Member 'WBP_PLLvExp_C_UpdateExp::AddExp' has a wrong offset!");
static_assert(offsetof(WBP_PLLvExp_C_UpdateExp, OldExp) == 0x000004, "Member 'WBP_PLLvExp_C_UpdateExp::OldExp' has a wrong offset!");
static_assert(offsetof(WBP_PLLvExp_C_UpdateExp, NowExpRate) == 0x000008, "Member 'WBP_PLLvExp_C_UpdateExp::NowExpRate' has a wrong offset!");
static_assert(offsetof(WBP_PLLvExp_C_UpdateExp, CallFunc_Add_IntInt_ReturnValue) == 0x000010, "Member 'WBP_PLLvExp_C_UpdateExp::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PLLvExp_C_UpdateExp, CallFunc_Greater_DoubleDouble_ReturnValue) == 0x000014, "Member 'WBP_PLLvExp_C_UpdateExp::CallFunc_Greater_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_PLLvExp_C_UpdateExp, CallFunc_UpdateGaugeEdgeImagePosition_percent_ImplicitCast) == 0x000018, "Member 'WBP_PLLvExp_C_UpdateExp::CallFunc_UpdateGaugeEdgeImagePosition_percent_ImplicitCast' has a wrong offset!");
static_assert(offsetof(WBP_PLLvExp_C_UpdateExp, CallFunc_SetPercent_InPercent_ImplicitCast) == 0x000020, "Member 'WBP_PLLvExp_C_UpdateExp::CallFunc_SetPercent_InPercent_ImplicitCast' has a wrong offset!");
static_assert(offsetof(WBP_PLLvExp_C_UpdateExp, CallFunc_Greater_DoubleDouble_A_ImplicitCast) == 0x000028, "Member 'WBP_PLLvExp_C_UpdateExp::CallFunc_Greater_DoubleDouble_A_ImplicitCast' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_54BE[0x6];                                     // 0x001A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_54BF[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
