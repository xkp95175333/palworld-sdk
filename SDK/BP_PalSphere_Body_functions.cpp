...
void ABP_PalSphere_Body_C::OnPassingCapturePhase______0(int32 PhaseCount, class UPalIndividualCharacterHandle* Param_TargetHandle)
{
	static class UFunction* Func = nullptr;
...
void ABP_PalSphere_Body_C::PrevIndexFullPercentage(int32 Param_Index, bool* IsFull)
{
	static class UFunction* Func = nullptr;
