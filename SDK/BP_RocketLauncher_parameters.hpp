...
public:
	...
	uint8                                         Pad_4B63[0x6];                                     // 0x0032(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4B64[0x7];                                     // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(BP_RocketLauncher_C_OnShoot) == 0x000010, "Wrong alignment on BP_RocketLauncher_C_OnShoot");
static_assert(sizeof(BP_RocketLauncher_C_OnShoot) == 0x0000B0, "Wrong size on BP_RocketLauncher_C_OnShoot");
static_assert(offsetof(BP_RocketLauncher_C_OnShoot, CallFunc_GetSocketTransform_ReturnValue) == 0x000000, "Member 'BP_RocketLauncher_C_OnShoot::CallFunc_GetSocketTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_OnShoot, CallFunc_BreakTransform_Location) == 0x000060, "Member 'BP_RocketLauncher_C_OnShoot::CallFunc_BreakTransform_Location' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_OnShoot, CallFunc_BreakTransform_Rotation) == 0x000078, "Member 'BP_RocketLauncher_C_OnShoot::CallFunc_BreakTransform_Rotation' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_OnShoot, CallFunc_BreakTransform_Scale) == 0x000090, "Member 'BP_RocketLauncher_C_OnShoot::CallFunc_BreakTransform_Scale' has a wrong offset!");
static_assert(offsetof(BP_RocketLauncher_C_OnShoot, CallFunc_SpawnSystemAtLocation_ReturnValue) == 0x0000A8, "Member 'BP_RocketLauncher_C_OnShoot::CallFunc_SpawnSystemAtLocation_ReturnValue' has a wrong offset!");
