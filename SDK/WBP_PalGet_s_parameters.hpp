...
public:
	...
	uint8                                         Pad_5420[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_5422[0x6];                                     // 0x000A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_5424[0x4];                                     // 0x0034(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_Conv_StringToText_ReturnValue;            // 0x0038(0x0018)()
	class FName                                   CallFunc_GetCharacterID_ReturnValue;               // 0x0050(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(WBP_PalGet_s_C_SetupByTargetHandle) == 0x000008, "Wrong alignment on WBP_PalGet_s_C_SetupByTargetHandle");
static_assert(sizeof(WBP_PalGet_s_C_SetupByTargetHandle) == 0x000058, "Wrong size on WBP_PalGet_s_C_SetupByTargetHandle");
...
static_assert(offsetof(WBP_PalGet_s_C_SetupByTargetHandle, CallFunc_GetCharacterID_ReturnValue) == 0x000050, "Member 'WBP_PalGet_s_C_SetupByTargetHandle::CallFunc_GetCharacterID_ReturnValue' has a wrong offset!");
