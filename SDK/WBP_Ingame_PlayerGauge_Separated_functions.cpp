...
// Parameters:
// class APalWeaponBase*                   WeaponBase                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// bool                                    Param_IsPalThrowWeapon                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UWBP_Ingame_PlayerGauge_Separated_C::IsPalThrowWeapon(class APalWeaponBase* WeaponBase, bool* Param_IsPalThrowWeapon)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_IsPalThrowWeapon != nullptr)
		*Param_IsPalThrowWeapon = Parms.Param_IsPalThrowWeapon;
}
...
void UWBP_Ingame_PlayerGauge_Separated_C::OnUpdateBallLoadoutSlot(class UPalItemSlot* Param_Slot)
{
	static class UFunction* Func = nullptr;
...
void UWBP_Ingame_PlayerGauge_Separated_C::OnUpdateGrenadeLoadoutSlot(class UPalItemSlot* Param_Slot)
{
	static class UFunction* Func = nullptr;
...
void UWBP_Ingame_PlayerGauge_Separated_C::SetVisibilityShield(bool Param_IsVisible)
{
	static class UFunction* Func = nullptr;
