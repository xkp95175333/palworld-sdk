...
public:
	...
	uint8                                         Pad_57F5[0x4];                                     // 0x000C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(WBP_PalCommonItemSlot_C_OnUpdateSlot_Binded, Param_TargetSlot) == 0x000000, "Member 'WBP_PalCommonItemSlot_C_OnUpdateSlot_Binded::Param_TargetSlot' has a wrong offset!");
