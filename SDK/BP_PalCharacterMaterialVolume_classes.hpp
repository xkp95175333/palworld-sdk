...
public:
	...
	void ForceOn();
	void ForceUpdate();
	void SetParameters(class UMaterialInstanceDynamic* Material, double Param_Light_Affect_Emissive_Intensity, double Param_Light_Affect_Emissive_Min, double Param_Light_Affect_Emissive_Max, double Param_Base_Emissive_Intensity, double Param_Base_Color_Intensity);
