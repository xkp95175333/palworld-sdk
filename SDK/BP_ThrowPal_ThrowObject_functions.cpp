...
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// class APalCharacter*                    Param_SpawnOtomo                                       (Parm, OutParm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void ABP_ThrowPal_ThrowObject_C::SpawnOtomo(class APalCharacter** Param_SpawnOtomo)
{
	static class UFunction* Func = nullptr;
	...
	if (Param_SpawnOtomo != nullptr)
		*Param_SpawnOtomo = Parms.Param_SpawnOtomo;
}
