...
public:
	...
	uint8                                         Pad_4964[0x7];                                     // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4965[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_4966[0x4];                                     // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4967[0x7];                                     // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4968[0x7];                                     // 0x0061(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_496B[0x3];                                     // 0x00BD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FPalUIActionBindData                   CallFunc_RegisterActionBinding_ReturnValue_3;      // 0x00C0(0x0004)(NoDestructor)
	uint8                                         Pad_496C[0x4];                                     // 0x00C4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_496D[0x3];                                     // 0x00D1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_496E[0x2];                                     // 0x000A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_496F[0x6];                                     // 0x0032(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4970[0x6];                                     // 0x004A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4971[0x3];                                     // 0x006D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	class UPalHUDDispatchParameter_MapObject*     K2Node_DynamicCast_AsPal_HUDDispatch_Parameter_Map_Object; // 0x0008(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess;                       // 0x0010(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4972[0x3];                                     // 0x0011(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	class FName                                   CallFunc_TryGetMapObjectId_ReturnValue;            // 0x0014(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4973[0x4];                                     // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class UPalItemContainer*                      CallFunc_TryGetContainer_OutContainer;             // 0x0038(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_4974[0x6];                                     // 0x0042(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_GetMapObjectName_outName;                 // 0x0048(0x0018)()
	class UBP_PalInventoryModel_C*                CallFunc_SpawnObject_ReturnValue;                  // 0x0060(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(WBP_ItemChest_C_Setup) == 0x000008, "Wrong alignment on WBP_ItemChest_C_Setup");
static_assert(sizeof(WBP_ItemChest_C_Setup) == 0x000068, "Wrong size on WBP_ItemChest_C_Setup");
static_assert(offsetof(WBP_ItemChest_C_Setup, CallFunc_GetParam_ReturnValue) == 0x000000, "Member 'WBP_ItemChest_C_Setup::CallFunc_GetParam_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_ItemChest_C_Setup, K2Node_DynamicCast_AsPal_HUDDispatch_Parameter_Map_Object) == 0x000008, "Member 'WBP_ItemChest_C_Setup::K2Node_DynamicCast_AsPal_HUDDispatch_Parameter_Map_Object' has a wrong offset!");
static_assert(offsetof(WBP_ItemChest_C_Setup, K2Node_DynamicCast_bSuccess) == 0x000010, "Member 'WBP_ItemChest_C_Setup::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(WBP_ItemChest_C_Setup, CallFunc_TryGetMapObjectId_ReturnValue) == 0x000014, "Member 'WBP_ItemChest_C_Setup::CallFunc_TryGetMapObjectId_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_ItemChest_C_Setup, CallFunc_GetItemContainerModule_ReturnValue) == 0x000020, "Member 'WBP_ItemChest_C_Setup::CallFunc_GetItemContainerModule_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(WBP_ItemChest_C_Setup, CallFunc_TryGetContainer_OutContainer) == 0x000038, "Member 'WBP_ItemChest_C_Setup::CallFunc_TryGetContainer_OutContainer' has a wrong offset!");
static_assert(offsetof(WBP_ItemChest_C_Setup, CallFunc_TryGetContainer_ReturnValue) == 0x000040, "Member 'WBP_ItemChest_C_Setup::CallFunc_TryGetContainer_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_ItemChest_C_Setup, CallFunc_Contains_ReturnValue) == 0x000041, "Member 'WBP_ItemChest_C_Setup::CallFunc_Contains_ReturnValue' has a wrong offset!");
static_assert(offsetof(WBP_ItemChest_C_Setup, CallFunc_GetMapObjectName_outName) == 0x000048, "Member 'WBP_ItemChest_C_Setup::CallFunc_GetMapObjectName_outName' has a wrong offset!");
static_assert(offsetof(WBP_ItemChest_C_Setup, CallFunc_SpawnObject_ReturnValue) == 0x000060, "Member 'WBP_ItemChest_C_Setup::CallFunc_SpawnObject_ReturnValue' has a wrong offset!");
