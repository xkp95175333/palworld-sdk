...
public:
	...
	uint8                                         Pad_15C3[0x30];                                    // 0x0040(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_15C8[0x6];                                     // 0x002A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_15C9[0x4];                                     // 0x00D4(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_15CA[0x120];                                   // 0x0028(0x0120)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	ECommonSessionOnlineMode                      OnlineMode;                                        // 0x0028(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bUseLobbies;                                       // 0x0029(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_15CD[0x6];                                     // 0x002A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_15CE[0x18];                                    // 0x0040(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_15CF[0x18];                                    // 0x0030(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_15D0[0x18];                                    // 0x0058(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_15D1[0x18];                                    // 0x0080(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_15D2[0x38];                                    // 0x00A8(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_15D3[0x51];                                    // 0x0037(0x0051)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_15D5[0x70];                                    // 0x0060(0x0070)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<int32, class UCommonUserInfo*>           LocalUserInfos;                                    // 0x00D0(0x0050)(Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	uint8                                         Pad_15D6[0x38];                                    // 0x0120(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])
