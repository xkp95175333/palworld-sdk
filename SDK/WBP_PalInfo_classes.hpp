...
public:
	...
	uint8                                         Pad_54A0[0x7];                                     // 0x02E1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void AnmEvent_OpenAndSetTimer(EPalUIPalInfoType InfoType);
...
static_assert(sizeof(UWBP_PalInfo_C) == 0x0003B0, "Wrong size on UWBP_PalInfo_C");
