...
public:
	void Display(class UPalBaseCampModel* TargetBaseCamp, const struct FPalInvaderDatabaseRow& ChosenInvaderData);
	...
	void PlayWarning(const class FText& TitleText, const class FText& InfoText);
	void RegisterEvents();
