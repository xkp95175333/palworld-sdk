...
void UWBP_MapMarker_Win_C::ChangeCustomIcon__DelegateSignature(class UWBP_Map_IconCustom_C* Icon, int32 Param_Index)
{
...
void UWBP_MapMarker_Win_C::ChangeIconType(int32 Param_Index)
{
	static class UFunction* Func = nullptr;
