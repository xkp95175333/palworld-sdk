...
public:
	...
	class UBP_PalTextBlock_C*                     Text_BaseCampName;                                 // 0x0288(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, InstancedReference, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
...
public:
	...
	void OnChangedBossBattlePlayerListEvent(class FName BossType, const TArray<class APalPlayerCharacter*>& PlayerList);
...
static_assert(offsetof(UWBP_BattleEntry_Member_C, Text_BaseCampName) == 0x000288, "Member 'UWBP_BattleEntry_Member_C::Text_BaseCampName' has a wrong offset!");
