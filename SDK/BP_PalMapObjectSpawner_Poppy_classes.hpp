...
static_assert(sizeof(ABP_PalMapObjectSpawner_Poppy_C) == 0x0002F0, "Wrong size on ABP_PalMapObjectSpawner_Poppy_C");
static_assert(offsetof(ABP_PalMapObjectSpawner_Poppy_C, StaticMesh3) == 0x0002D8, "Member 'ABP_PalMapObjectSpawner_Poppy_C::StaticMesh3' has a wrong offset!");
static_assert(offsetof(ABP_PalMapObjectSpawner_Poppy_C, StaticMesh1) == 0x0002E0, "Member 'ABP_PalMapObjectSpawner_Poppy_C::StaticMesh1' has a wrong offset!");
static_assert(offsetof(ABP_PalMapObjectSpawner_Poppy_C, StaticMesh2) == 0x0002E8, "Member 'ABP_PalMapObjectSpawner_Poppy_C::StaticMesh2' has a wrong offset!");
