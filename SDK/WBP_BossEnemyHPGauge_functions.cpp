...
// Parameters:
// class APalCharacter*                    Param_TargetCharacter                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void UWBP_BossEnemyHPGauge_C::OnDead__DelegateSignature(class APalCharacter* Param_TargetCharacter)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Param_TargetCharacter = Param_TargetCharacter;
...
void UWBP_BossEnemyHPGauge_C::SetTargetCharacter(class APalCharacter* Param_TargetCharacter)
{
	static class UFunction* Func = nullptr;
