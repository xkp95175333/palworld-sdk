...
void AStemSpline_BP_C::_Bridge__TraceTowardsDirection(const struct FVector& StartLocation, const struct FVector& RelativeNormal, const struct FVector& Param_Direction, bool* HitSomething, struct FVector* LastLocation, struct FVector* HitLocation, struct FVector* HitNormal, struct FVector* TraceDirection)
{
...
void AStemSpline_BP_C::FindBridgeEdge(int32 MaxSegmentChecks, const struct FVector& FromWhere, const struct FVector& StartNormal, const struct FVector& Param_Direction, bool* Found, struct FVector* EdgeLocation, struct FVector* EdgeNormal)
{
	static class UFunction* Func = nullptr;
