...
static_assert(sizeof(ABP_PalMapObjectSpawner_RedBerry_C) == 0x0002E0, "Wrong size on ABP_PalMapObjectSpawner_RedBerry_C");
static_assert(offsetof(ABP_PalMapObjectSpawner_RedBerry_C, Mesh) == 0x0002D8, "Member 'ABP_PalMapObjectSpawner_RedBerry_C::Mesh' has a wrong offset!");
