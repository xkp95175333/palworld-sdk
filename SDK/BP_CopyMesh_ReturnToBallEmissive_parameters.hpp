...
public:
	...
	uint8                                         Pad_4D08[0x2];                                     // 0x0006(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4D09[0x2];                                     // 0x0036(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4D0A[0x2];                                     // 0x003E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4D0B[0x4];                                     // 0x0074(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4D0C[0x4];                                     // 0x008C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(alignof(BP_CopyMesh_ReturnToBallEmissive_C_PlayPalReturnSound) == 0x000008, "Wrong alignment on BP_CopyMesh_ReturnToBallEmissive_C_PlayPalReturnSound");
static_assert(sizeof(BP_CopyMesh_ReturnToBallEmissive_C_PlayPalReturnSound) == 0x000028, "Wrong size on BP_CopyMesh_ReturnToBallEmissive_C_PlayPalReturnSound");
static_assert(offsetof(BP_CopyMesh_ReturnToBallEmissive_C_PlayPalReturnSound, Temp_struct_Variable) == 0x000000, "Member 'BP_CopyMesh_ReturnToBallEmissive_C_PlayPalReturnSound::Temp_struct_Variable' has a wrong offset!");
static_assert(offsetof(BP_CopyMesh_ReturnToBallEmissive_C_PlayPalReturnSound, Temp_delegate_Variable) == 0x000010, "Member 'BP_CopyMesh_ReturnToBallEmissive_C_PlayPalReturnSound::Temp_delegate_Variable' has a wrong offset!");
static_assert(offsetof(BP_CopyMesh_ReturnToBallEmissive_C_PlayPalReturnSound, CallFunc_PostEvent_ReturnValue) == 0x000020, "Member 'BP_CopyMesh_ReturnToBallEmissive_C_PlayPalReturnSound::CallFunc_PostEvent_ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4D0E[0x3];                                     // 0x0035(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	int32                                         Temp_int_Loop_Counter_Variable;                    // 0x000C(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Add_IntInt_ReturnValue;                   // 0x0010(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4D0F[0x4];                                     // 0x0014(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UMaterialInstanceDynamic*>       CallFunc_GetMainMeshMaterials_ReturnValue;         // 0x0018(0x0010)(ReferenceParm)
	class UMaterialInstanceDynamic*               CallFunc_Array_Get_Item;                           // 0x0028(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Array_Length_ReturnValue;                 // 0x0030(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Less_IntInt_ReturnValue;                  // 0x0034(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4D10[0x3];                                     // 0x0035(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CallFunc_SetScalarParameterValue_Value_ImplicitCast; // 0x0038(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
