...
public:
	...
	int32                                         Index_WBP_MapMarker_Content_C;                     // 0x02A0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_52DE[0x4];                                     // 0x02A4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void SetIndex(int32 Param_Index, class UTexture2D* Texture);
...
static_assert(offsetof(UWBP_MapMarker_Content_C, Index_WBP_MapMarker_Content_C) == 0x0002A0, "Member 'UWBP_MapMarker_Content_C::Index_WBP_MapMarker_Content_C' has a wrong offset!");
