...
void UWBP_Ingame_PalHPGauge_C::GetNextOtomoSlot(class UPalIndividualCharacterSlot** Param_Slot, bool* IsEmpty)
{
	static class UFunction* Func = nullptr;
...
void UWBP_Ingame_PalHPGauge_C::GetPrevOtomoSlot(class UPalIndividualCharacterSlot** Param_Slot, bool* IsEmpty)
{
	static class UFunction* Func = nullptr;
